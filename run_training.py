...
from dnnlib.tflib.tfutil import _sanitize_tf_config
...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics):
    ...
    config_proto = _sanitize_tf_config(tf_config)
...
def main():
    ...
    parser.add_argument('--num-gpus', help='Number of GPUs (default: %(default)s)', default=0, type=int, metavar='N')
